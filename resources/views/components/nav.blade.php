    ...
    <div class="p-4 relative">
        ...
        @auth
            ...
            <nav class="space-y-2">
                ...
                {{ request()->is('dashboard') ? 'border-l-4 border-green-700 bg-green-100 text-green-700' : '' }} transition-all hover:pl-5 hover:ml-3" group>
                ...
                @if ($role == 'admin' || $role == 'staff')
                    <div>
                        ...
                        {{ request()->is('users', 'users/create', 'users/*') ? 'border-l-4 border-green-700 bg-green-100 text-green-700' : '' }} transition-all hover:pl-5 hover:ml-3  group ">
                            ...
                            <i id="membersIcon"
                                class="fa-solid fa-chevron-right ml-auto transition-transform duration-300"></i>
                        </button>
                    ...
                    <a href="{{ route('savings.index') }}"
                        class="flex items-center py-2 px-4 text-gray-700 hover:bg-gray-200 rounded transition capitalize 
                    {{ request()->is('savings', 'savings/*') ? 'border-l-4 border-green-700 bg-green-100 text-green-700' : '' }} transition-all hover:pl-5 hover:ml-3" group>
                ...
                <div>
                    ...
                    <button id="loansButton"
                        class="flex items-center py-2 px-4 w-full text-gray-700 hover:bg-gray-200 rounded transition capitalize 
                        {{ request()->is('loans', 'loans/create', 'loans/*', 'loan-categories/*') ? 'border-l-4 border-green-700 bg-green-100 text-green-700' : '' }} transition-all hover:pl-5 hover:ml-3" group>
                ...
                <a href="{{ route('transactions.index') }}"
                    class="flex items-center py-2 px-4 text-gray-700 hover:bg-gray-200 rounded transition capitalize 
                    {{ request()->is('transactions', 'transactions/*') ? 'border-l-4 border-green-700 bg-green-100 text-green-700' : '' }} transition-all hover:pl-5 hover:ml-3" group>
                ...
                <div>
                    ...
                    <button id="reportsButton"
                      class="flex items-center py-2 px-4 w-full text-gray-700 hover:bg-gray-200 rounded transition capitalize 
                             ...
                             transition-all hover:pl-5 hover:ml-3" group>
                ...
                <a href="{{ route('settings.index') }}"
                    class="flex items-center py-2 px-4 text-gray-700 hover:bg-gray-200 rounded transition capitalize 
                    {{ request()->is('settings', 'settings/*') ? 'border-l-4 border-green-700 bg-green-100 text-green-700' : '' }} transition-all hover:pl-5 hover:ml-3" group>
