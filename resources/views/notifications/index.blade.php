<x-layout>
    ...
    @section('content')
        ...
        <div class="container mr-auto flex flex-col w-full h-full">
            <!-- Page Header -->
            <div class="flex justify-end items-center mb-6">
                <h1 class="text-2xl font-semibold text-gray-800"></h1>
                <div class="flex space-x-4">
                    <a href="{{ route('notifications.markAllAsRead') }}"
                       class="px-3 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 focus:outline-none">
                        <i class="fa-solid fa-check-double mr-2"></i>Mark All as Read
                    </a>
                    <a href="{{ route('notifications.clearAll') }}"
                       class="px-3 py-2 bg-red-500 text-white rounded-lg hover:bg-red-600 focus:outline-none">
                ...
                <ul class="divide-y divide-gray-200">
                    @forelse ($notifications as $notification)
                        <li class="p-4 hover:bg-gray-50 transition-colors duration-200 flex items-center justify-between">
                            ...
                            <!-- Mark as Read Button or Read Label -->
                            ...
                            @else
                                <span class="text-sm text-gray-500 italic">Read</span>
                            @endif
                        </li>
                    @empty
                        <!-- Empty State -->
